...
test1_set = test_datagen.flow_from_directory('dataset/single_prediction',
                                            target_size = (64, 64),
                                            batch_size = 32,
                                            class_mode = 'binary')
...
import pandas as pd
import os
images=glob.glob("/home/yi-hsuancheng/Desktop/DogCat/test2/test/*.jpg")
sub = pd.DataFrame()
i= 0
...
sub['ID']=os.listdir('/home/yi-hsuancheng/Desktop/DogCat/test2/test/')
sub['DOG']=dog
sub['CAT']=cat 
sub.head()
